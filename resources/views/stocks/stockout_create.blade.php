...
<form action="{{ route('stockout.removeStock') }}" method="post">
    @csrf
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <select name="customer_id" class="w-full py-1.5 px-4" >
        ...
        @enderror
          ...
          <div class="sm:col-span-1">
            ...
            <div class="mt-2">
              <input  name="quantity_out" id="quantity_add" type="number" class="block  w-screen  px-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"  />
